...
namespace DBHelper.SQLKinetic
{
    public class KineticVJobInformationAll
    {
        ...
        {
            string sqlCmd = string.Format("select * from dbo.v_EpicorAccess_JobInformationNotReleased where JobNum = '{0}'", this.JobNum);
