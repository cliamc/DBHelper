...
namespace DBHelper.SQLKinetic
{
    ...
    public class KineticVPartWhereUsedFGAllRev
    {
        ...
        public KineticVPartWhereUsedFGAllRev(string pn, string ver)
        {
            this.partNum = pn;
            this.partRev = ver;
        ...
        {
            string sqlCmd = string.Format("select * from dbo.v_PartWhereUsedFG_AllRev where PartNum = '{0}' and RevisionNum = '{1}' order by MtlPartNum", this.partNum, this.partRev);
